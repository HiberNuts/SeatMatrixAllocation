...
const PersonalDetails = ({ alter, Data, toggleIconTab, updateCollegeInfo }) => {
  ...
  const getCollegeInfo = async (data) => {
    ...
    if (["NM", "CENTRAL GOVT", "GOVT", "GOVT AIDED", "UNIV"].includes(data?.Category)) setMinorityStatus("No");
    else setMinorityStatus("Yes");
    if (data.Booklet) {
    ...
    <React.Fragment>
      <Form className={formClass} onSubmit={handleSubmit((data) => onFormSubmit(data))}>
            ...
            <div className="form-group">
              ...
              <div className="form-control-wrap">
                <input
                  ...
                  value={phone}
                />
                {errors.phone && errors.phone.type === "required" && <span className="invalid">This is required</span>}
            ...
            <div className="form-group">
              ...
              <div className="form-control-wrap">
                <input
                  ...
                  value={taluk}
                />
                {errors.taluk && errors.taluk.type === "required" && <span className="invalid">This is required</span>}
            ...
            <div className="form-group">
              ...
              <div className="form-control-wrap">
                <input
                  ...
                  value={NACCGrade}
                />
                {errors.grade && errors.grade.type === "required" && <span className="invalid">This is required</span>}
              </div>
            </div>
          </Col>
          <Col hidden={!NACCbool} md="6">
            <div className="form-group">
              ...
              <div className="form-control-wrap">
                <input
                  ...
                  value={NACCValid}
                />
                {errors.valid && errors.valid.type === "required" && <span className="invalid">This is required</span>}
              </div>
            </div>
          </Col>
        </Row>
        ...
        <div className="pt-5 d-flex justify-content-between">
          <Button name="submit" disabled={frozen} type="submit" color={editFlag ? "warning" : "primary"} size="lg">
            {editFlag ? "Save" : "Edit"}
          </Button>
          <Button
            onClick={(e) => {
